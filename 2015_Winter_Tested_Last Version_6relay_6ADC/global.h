...
#define		RELAY1_BIT	PD0
#define		RELAY2_BIT	PD1
#define		RELAY3_BIT	PD2
#define		RELAY4_BIT	PD3
#define		RELAY5_BIT	PD4
#define		RELAY6_BIT	PD5
...
#define		ADC7		a2dConvert10bit(ADC_CH7)
#define		ADC8		a2dConvert10bit(ADC_CH8)
...
#define	HTTP_404		"HTTP/1.0 404 OK\r\nContent-Type: text/html\r\n\r\n<h1>ZSP.Co (please go to ip/index.html)<h1>"
...
#define	INDEX_HTML	"<link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\" />" \
                    ...
                    "<td><p>RELAY5</p><input type=\"submit\" name=\"B5\" value=\"TOGGLE\"/></td>" \
...
#define	STYLE_CSS	"body{background-color:#99ff99;}" \
